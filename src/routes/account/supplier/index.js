...
import FormSaveSupplier from './FormSaveSupplier';
const columns = [
	{
		key: 'image',
...
class ListSupplier extends Component {
	...
	onEditAccount = (account) => () => {
		this.setState({ addSupplierState: true, current_account: account, edit: true });
	};
	onAccountClose = () => {
		this.setState({ addSupplierState: false, current_account: null, edit: false });
	};
	...
	onRefresh = () => {
		...
		this.setState(
			...
			() => this.props.listAccountAction(this.state.filter, 'supplier')
		);
	};
	getOrder = (order) => {
		...
		return (
			<React.Fragment>
				<div className="formelements-wrapper">
					<div className="row">
						<RctCollapsibleCard heading="List Supplier" colClasses="col-12">
							<TableActionBar2
