...
class FormSaveSupplier extends Component {
	static propTypes = {
			...
			<React.Fragment>
				{open ? (
					<Modal
						title={
							edit ? (
								<IntlMessages id="account.updateSupplier" />
							) : (
...
export default Form.create({ name: 'supplier' })(connect(mapStateToProps, mapDispatchToProps)(FormSaveSupplier));
