...
class PawnScreen extends React.Component {
    ...
    componentWillReceiveProps({getContractsRes}) {
        console.log("isCanLoadMore", getContractsRes.isCanLoadMore);
        if (getContractsRes.type === this.type) {
            ...
            this.setState({
                data: data,
                isRefresh: getContractsRes.isRefresh,
                isCanLoadMore: getContractsRes.isCanLoadMore
            })
        }
    }
    ...
    onPressItem = (item) => () => {
        this.props.navigation.navigate("contractDetail", {item: item, type: this.type, onRefreshContracts:this._onRefresh})
    }
    _item = (item, index) => {
        return ( 
            <MButton
                ...
                <View style={styles.itemBoxHeader}>
                    ...
                    <View  style={{flex: 1}}>
                        <TextHelvetica style={{flex: 1, textAlign: 'right', color: "#EE5723",fontSize:17, fontWeight: "bold"}}>
                ...
                <View style={styles.itemBox}>
                    <View style={styles.boxIcon}>
                        <Octicons name='note' size={17} color={Style.secondaryColor}/>
                    </View>
                ...
                <View style={styles.itemBox}>
                    <View style={styles.boxIcon}>
                        <MaterialIcons name='motorcycle' size={17} color={Style.secondaryColor}/>
                    </View>
                    <TextHelvetica style={styles.itemBoxTextRight}>
                        Tài sản
                    </TextHelvetica>
                ...
                <View style={styles.itemBox}>
                    ...
                    <View  style={{flex: 1}}>
                        <TextHelvetica style={styles.itemBoxTextLeft}>
                            {Utilities.instance().convertToSimpleTime(item.FromDate)} {item.BorrowedDay}
                        </TextHelvetica>
