...
export default (state = INIT_STATE, action) => {
    switch (action.type) {
        ...
        case LOGOUT_USER:
            return { ...state, isLoading: false, isSuccess:false, isError:false, data: null, message:action.message };
        case CHECK_TOKEN_SUCCESS:
            return {...state, isLoading: false, isSuccess:false, isError:false,  data: action.payload, message:action.message}
        case CHECK_TOKEN_ERROR:
            return {...state, isLoading: false, isSuccess:false, isError:false, data: null, message:action.message}
        default: return { ...state, isSuccess:false };
    }
}
